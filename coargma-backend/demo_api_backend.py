...
model = AutoModelForSequenceClassification.from_pretrained("uhhlt/roberta_binary_classifier", num_labels=2)
tokenizer = AutoTokenizer.from_pretrained('uhhlt/roberta_binary_classifier/')
